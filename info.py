...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6519828448:AAGfYsaeedMIhOCT6riRz0funxN2IvaMq5Q')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '5344594309')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002140187068')
...
# support group
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1002140187068')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://123:123@cluster0.pjw5izx.mongodb.net/?retryWrites=true&w=majority")
...
OWNER_USERNAME = environ.get("OWNER_USERNAME", "https://t.me/jacksparrroww1")
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002140187068")
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://harepo.onrender.com")
if len(URL) == 0:
